...
const Portfolio: React.FC = () => {
  ...
  return (
    <div className="bg-brand-deep min-h-screen transition-colors duration-300 relative overflow-hidden py-24">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(rgba(17,34,64,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(17,34,64,0.1)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(0,163,204,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,163,204,0.03)_1px,transparent_1px)] bg-[size:50px_50px] pointer-events-none"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <RevealOnScroll>
          <div className="text-center mb-20">
             <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-surface border border-brand-primary/30 text-brand-primary text-xs font-bold tracking-widest uppercase mb-6 shadow-[0_0_15px_rgba(0,163,204,0.2)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {projects.map((project, index) => (
            <RevealOnScroll key={project.id} delay={index * 150}>
              <div className="group relative h-full bg-brand-surface/60 backdrop-blur-md rounded-2xl overflow-hidden border border-brand-surfaceLight hover:border-brand-primary/50 transition-all duration-500 hover:shadow-[0_0_40px_rgba(0,163,204,0.15)] flex flex-col">
